...
class Discarded(models.Model):
    Barcode = models.CharField(db_column = 'Barcode', max_length = 20,blank=True)
...
class Man(models.Model):
    ...
    volret = models.CharField(db_column='VOLRET', max_length=20, blank=True, null=True)  # Field name made lowercase.
    ...
    capacity = models.CharField(db_column='CAPACITY', max_length=20, blank=True, null=True)  # Field name made lowercase.
    typefull = models.CharField(db_column='TYPEFULL', max_length=20, blank=True, null=True)  # Field name made lowercase.
    name = models.CharField(db_column='NAME', max_length=200, blank=True, null=True)  # Field name made lowercase.
    clretent = models.CharField(db_column='CLRETENT', max_length=20, blank=True, null=True)  # Field name made lowercase.
...
class Masterlist1(models.Model):
    barcode = models.CharField(db_column='BARCODE', max_length=20, blank=True, null=True)  # Field name made lowercase.
...
class Network1(models.Model):
    ...
    typefull = models.CharField(db_column='TYPEFULL', max_length=30, blank=True, null=True)  # Field name made lowercase.
